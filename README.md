...
* [CodeCat](https://github.com/CoolerVoid/codecat) - CodeCat is a open source tool to help you in static code analysis, to find/track sinks and bugs, you can create your custom rules...
